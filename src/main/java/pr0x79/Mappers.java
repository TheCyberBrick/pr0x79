...
public final class Mappers {
	...
	Mappers(Bootstrapper bootstrapper) {
	 ...
	 * @return
	 */
	public synchronized IClassMapper unregisterClassMapper(String id) {
		this.checkBootstrapperState();
	 ...
	 * @return
	 */
	public synchronized IFieldMapper unregisterFieldMapper(String id) {
		this.checkBootstrapperState();
	 ...
	 * @return
	 */
	public synchronized IMethodMapper unregisterMethodMapper(String id) {
		this.checkBootstrapperState();
	 ...
	 * @return
	 */
	public synchronized IInstructionMapper unregisterInstructionMapper(String id) {
		this.checkBootstrapperState();
	...
	private void checkBootstrapperState() {
		if(!this.bootstrapper.isInitializing()) {
			throw new RuntimeException("Mappers must be (un-)registered during the bootstrap initialization");
		}
	}
}
